...
public class GlavniProzor extends JFrame {
	...
	private JPanel glavniSadrzaj; // Panel koji stoji u sredini i menja se
	...
	public GlavniProzor(Korisnik ulogovaniKorisnik, KorisniciPodaci kp, ModeliVozilaPodaci mp, VozilaPodaci vp, DodatneUslugePodaci dup,
		...
		setSize(900, 600); // Povećao sam prozor jer u njega sada idu tabele
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setLocationRelativeTo(null);
		
		// Inicijalizujemo središnji deo (Kontejner za sve tabele)
		...
		glavniSadrzaj.add(lblDobrodosli, BorderLayout.CENTER); // Početna poruka
		
		kreirajMeni();
	}

	// Metoda koja menja pogled (sadržaj u sredini prozora)
	private void prikaziPanel(JPanel noviPanel) {
		glavniSadrzaj.removeAll();
		glavniSadrzaj.add(noviPanel, BorderLayout.CENTER);
		glavniSadrzaj.revalidate(); // Obezbeđuje osvežavanje GUI-ja

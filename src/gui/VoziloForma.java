...
public class VoziloForma extends JDialog {
	...
	public VoziloForma(VozilaPodaci vp, ModeliVozilaPodaci mp, Vozilo vZaIzmenu, Runnable naUspesnoDodavanje) {
		...
		for (ModelVozila m : mp.getModeli()) {
			cbModel.addItem(m); // Zato što ModelVozila ima toString(), JComboBox će ga lepo ispisati!
		}
		add(cbModel);
	...
	private void popuniPolja() {
		...
		// Postavljamo ComboBox na tačan model koji vozilo ima. 
		// Pošto imamo iste reference na modele iz memorije, selekcija će raditi.

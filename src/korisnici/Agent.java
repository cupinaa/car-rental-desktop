...
public class Agent extends Zaposleni{
	...
	public Agent(int id, String ime, String prezime, Pol pol, LocalDate datumRodjenja, String telefon,
	...
	public Agent(String ime, String prezime, Pol pol, LocalDate datumRodjenja, String telefon,
			String adresa, String korisnickoIme, String lozinka, StrucnaSprema strucnaSprema, int godineStaza) {
